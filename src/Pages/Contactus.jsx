        ...
        >
          <div>
            ...
            <p className={`text-sm leading-6 ${isDark ? "text-gray-400" : "text-gray-600"}`}>
              Feel free to reach out for collaborations, freelance work, or just a friendly hello. I'll get back to you as soon as possible!
            </p>
          </div>

          {[
            { icon: <FaPhone className="text-amber-500" size={20} />, label: "Phone", },
            { icon: <FaEnvelope className="text-amber-500" size={20} />, label: "Email",  },
            { icon: <FaMapMarkerAlt className="text-amber-500" size={20} />, label: "Location", },
          ].map((item, i) => (
            <motion.div
              key={i}
              whileHover={{ x: 6 }}
            ...
            >
              <div className={`p-3 rounded-full ${isDark ? "bg-gray-700" : "bg-amber-100"}`}>
                {item.icon}
              </div>
              <div>
                ...
                <p className="font-semibold">{personalInfo[item.label.toLowerCase()]}</p>
              </div>
            </motion.div>
          ))}
          ...
          <div className="flex gap-4 mt-2">
            {[
                { icon: <FaInstagram size={20} />, href: personalInfo.instagram, label: "Instagram" },
              ...
              <motion.a
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg border font-semibold text-sm transition duration-200 ${
                  isDark
